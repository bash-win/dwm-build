...
static const unsigned int gappiv = 5; /* inner vertical gap */
static const unsigned int gappoh = 5; /* outer horizontal gap */
static const unsigned int gappov = 5; /* outer vertical gap */
/* underline settings */
...
static const char col_cyan[]  = "#bb9af7"; /* active border */
...
static const char *screenshot[] = { "~/.local/bin/screenshot" };
